...
const btnClass = "border border-white bg-transparent text-white px-4 sm:px-8 py-3 rounded transition-all duration-300 hover:bg-black hover:text-white hover:scale-105";
const cardClass = "p-6 border border-white rounded transition-all duration-300 hover:shadow-lg hover:scale-105";
    ...
    <div className="min-h-screen bg-gray-900">
      <div className="max-w-6xl mx-auto px-4 py-16">
        <div className="text-center mb-16">
          <h1 className="text-4xl sm:text-6xl font-bold text-white mb-6 transition-all duration-300 hover:scale-105">
            Medium
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/lab3/editor" className={btnClass}>Start Writing</Link>
            <Link href="/lab4/posts" className={btnClass}>Read All Posts</Link>
          </div>
        </div>
        ...
        <div className="text-center">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <Link href="/lab2/signup" className="block p-6 border border-white rounded transition-all duration-300 hover:bg-black hover:scale-105 group">
            ...
            <Link href="/lab2/login" className="block p-6 border border-white rounded transition-all duration-300 hover:bg-black hover:scale-105 group">
